...
$("#hour-1 .description").val(localStorage.getItem("hour-01"));
$("#hour-2 .description").val(localStorage.getItem("hour-02"));
$("#hour-3 .description").val(localStorage.getItem("hour-03"));
$("#hour-4 .description").val(localStorage.getItem("hour-04"));
$("#hour-5 .description").val(localStorage.getItem("hour-05"));
